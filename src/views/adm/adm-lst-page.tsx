...
import * as schema from "applitutoriel-js-test/src/views/adm/adm-lst-page-validation.json";
import * as schemaEditionTable from "applitutoriel-js-test/src/views/adm/adm-lst-table-validation.json";
...
export class SecteursPage extends HornetPage<AdministrationSecteurService, HornetComponentProps, any> {
    ...
    constructor(props?, context?) {
        ...
        this.dataSource = new DataSource<any>([], {}, [sort]);
    }
