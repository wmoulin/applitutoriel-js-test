...
import { SubModuleServiceRequest } from "applitutoriel-js-test/src/services/sub-module-service-request";
 ...
 * @extends {ServiceApi}
 */
export class SecteurServiceImpl extends /*AdministrationSecteurService*/SubModuleServiceRequest {
